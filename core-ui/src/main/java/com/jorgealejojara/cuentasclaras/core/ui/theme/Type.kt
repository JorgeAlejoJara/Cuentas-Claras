...
val CuentasClarasTypography = Typography(
    ...
    headlineLarge = TextStyle(fontWeight = FontWeight.W500, fontSize = 32.sp, lineHeight = 40.sp, letterSpacing = (-0.2).sp),
    headlineMedium = TextStyle(fontWeight = FontWeight.W500, fontSize = 28.sp, lineHeight = 36.sp),
    headlineSmall = TextStyle(fontWeight = FontWeight.W500, fontSize = 24.sp, lineHeight = 32.sp),
